#include "painter_9_3_reflection_cubemap.h"

void Painter_9_3::init()
{
    title = "Example 9.3";

    vert = "./shader/s_9_3_reflection_cubemap_vert.glsl";
    frag = "./shader/s_9_3_reflection_cubemap_frag.glsl";

	vert_cubemap = "./shader/s_9_2_cubemap_vert.glsl";
	frag_cubemap = "./shader/s_9_2_cubemap_frag.glsl";

	tex0 = "./res/img/castleroof.jpg";
	texSkybox = "./res/skybox/cube_map/lake_islands";

	torLocX = 0.0f; torLocY = -0.75f; torLocZ = 0.0f;
	cameraX = 0.0f; cameraY = 0.0f; cameraZ = 5.0f;
}

void Painter_9_3::initWin(GLFWwindow* window)
{
...
void Painter_9_3::display(GLFWwindow* window, double currentTime)
{
	...
	vMat *= rotate(glm::mat4(1.0f), 2.0f * s, glm::vec3(1.0f, 1.0f, 1.0f));
