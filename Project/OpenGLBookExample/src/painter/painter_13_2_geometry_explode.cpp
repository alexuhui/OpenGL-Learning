#include "painter_13_2_geometry_explode.h"
...
void Painter_13_2::init()
{
    ...
    geom = "./shader/s_13_2_geometry_explode_geom.glsl";
}


void Painter_13_2::initWin(GLFWwindow* window)
{
...
void Painter_13_2::display(GLFWwindow* window, double currentTime)
{
