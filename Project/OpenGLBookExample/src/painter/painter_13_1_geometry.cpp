#include "painter_13_1_geometry.h"

void Painter_13_1::init()
{
    title = "Example 13.1";

    vert = "./shader/s_13_1_geometry_vert.glsl";
    frag = "./shader/s_13_1_geometry_frag.glsl";
    geom = "./shader/s_13_1_geometry_geom.glsl";
}


void Painter_13_1::initWin(GLFWwindow* window)
{
...
void Painter_13_1::display(GLFWwindow* window, double currentTime)
{
